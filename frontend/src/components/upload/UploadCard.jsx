  ...
  return (
    <div className="flex-1 flex items-center justify-center relative">
      ...
      <div className="bg-white rounded-4xl shadow-[8px_16px_32px_rgba(96,56,8,0.08)] w-full aspect-square max-w-md flex flex-col items-center justify-center p-10">
        ...
        <button className="bg-primary text-white font-semibold px-10 py-3 rounded-full shadow-[0px_4px_4px_rgba(96,56,8,0.15)] flex items-center gap-3 hover:bg-primary-hover transition">
          <Camera size={20} />
          Select Photo
        </button>
      </div>
